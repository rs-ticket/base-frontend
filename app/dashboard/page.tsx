                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-2.jpg" className="avatar avatar-sm me-3" alt="user1" width={36} height={36} />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-3.jpg" className="avatar avatar-sm me-3" alt="user2" width={36} height={36} />
                                                    </div>
                                                    <div className="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-4.jpg" className="avatar avatar-sm me-3" alt="user3" width={36} height={36} />
                                                    </div>
                                                    <div className="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-3.jpg" className="avatar avatar-sm me-3" alt="user4" width={36} height={36} />
                                                    </div>
                                                    <div className="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-2.jpg" className="avatar avatar-sm me-3" alt="user5" width={36} height={36} />
                                                    </div>
                                                    <div className="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2 py-1">
                                                    <div>
                                                        <Image src="/assets/img/team-4.jpg" className="avatar avatar-sm me-3" alt="user6" width={36} height={36} />
                                                    </div>
                                                    <div className="d-flex flex-column justify-content-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-spotify.svg" className="avatar avatar-sm rounded-circle me-2" alt="spotify" width={36} height={36} />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-invision.svg" className="avatar avatar-sm rounded-circle me-2" alt="invision" width={36} height={36} />
                                                    </div>
                                                    <div className="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-jira.svg" className="avatar avatar-sm rounded-circle me-2" alt="jira" width={36} height={36} />
                                                    </div>
                                                    <div className="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-slack.svg" className="avatar avatar-sm rounded-circle me-2" alt="slack" width={36} height={36} />
                                                    </div>
                                                    <div className="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-webdev.svg" className="avatar avatar-sm rounded-circle me-2" alt="webdev" width={36} height={36} />
                                                    </div>
                                                    <div className="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex px-2">
                                                    <div>
                                                        <Image src="/assets/img/small-logos/logo-xd.svg" className="avatar avatar-sm rounded-circle me-2" alt="xd" width={36} height={36} />
                                                    </div>
                                                    <div className="my-auto">
